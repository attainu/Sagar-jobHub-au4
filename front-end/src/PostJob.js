                                ...
                                <div className="form-group">
                                    ...
                                    <select
                                        ...
                                        <optgroup label="Consultant">
                                            ...
                                            <option data_category_id="5" value="Recruitment Consultant">
                                                Recruitment Consultant
                                            </option>

                                            <option data_category_id="5" value="Interior Designer">
                                                Interior Designer
                                            </option>
                                        ...
                                        <optgroup label="Computer">
                                            ...
                                            <option data_category_id="7" value="Devops Engineer">
                                                Devops Engineer
                                            </option>
                                        ...
                                        <optgroup label="IT - Software">
                                            ...
                                            <option data_category_id="9" value="Java Script Developer">
                                                Java Script Developer
                                            </option>

                                            <option data_category_id="9" value="Senior Java Developer">
                                                Senior Java Developer
                                            </option>

                                            <option data_category_id="9" value="Senior Web Designer">
                                                Senior Web Designer
                                            </option>

                                            <option data_category_id="9" value="Senior Web Developer">
                                        ...
                                        <optgroup label="Architect">
                                            <option data_category_id="10" value="Architect">
                                                Architect
                                            </option>

                                            <option data_category_id="10" value="Project Architect">
                                                Project Architect
                                            </option>

                                            <option data_category_id="10" value="Interior Designer">
                                                Interior Designer
                                            </option>

                                            <option data_category_id="10" value="Project Manager">
                                                Project Manager
                                            </option>
                                        ...
                                        <optgroup label="Advertising">
                                            <option data_category_id="67" value="Brand Manager">
                                                Brand Manager
                                            </option>

                                            <option data_category_id="67" value="Branding">
                                                Branding
                                            </option>

                                            <option data_category_id="67" value="Internship">
                                                Internship
                                            </option>
